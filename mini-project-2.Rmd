...
*If your data is already as tidy as it can be, just explain why the dataset is appropriate and you'll receive full marks. you can ignore the 4 - 8 functions requirements.* (Added accroding to slack anouncement).
